  ...
  */
  ...
  return {
    ...
    uploadData: function (progress, data, cb) {
      ...
      const latestRecord = [data.post_records.pop()];
      debug('Uploading the latest record', data.post_records, latestRecord);

      cfg.api.upload.toPlatform(latestRecord, sessionInfo, progress, cfg.groupId, function (err, result) {
        progress(100);
