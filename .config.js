...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://dev-connect.sensotrend.fi/tpapi',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://dev-connect.sensotrend.fi/tpupload',
  DATA_URL: process.env.DATA_URL || 'https://dev-connect.sensotrend.fi/tpdata',
  BLIP_URL: process.env.BLIP_URL || 'https://dev-connect.sensotrend.fi/view',
