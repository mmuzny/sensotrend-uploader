...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://intersystems-demo.sensotrend.fi/tpapi',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://intersystems-demo.sensotrend.fi/tpupload',
  DATA_URL: process.env.DATA_URL || 'https://intersystems-demo.sensotrend.fi/tpdata',
  BLIP_URL: process.env.BLIP_URL || 'https://dev.sensotrend.fi/api',
