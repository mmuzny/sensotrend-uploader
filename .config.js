...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://test-connect.sensotrend.fi/tpapi',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://test-connect.sensotrend.fi/tpupload',
  DATA_URL: process.env.DATA_URL || 'https://test-connect.sensotrend.fi/tpdata',
  BLIP_URL: process.env.BLIP_URL || 'https://sensotrend.fi/dashboard/agp/',
